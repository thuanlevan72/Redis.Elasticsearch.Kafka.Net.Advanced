...
/// </summary>
public class TodoCreatedEventHandler : INotificationHandler<TodoCreatedNotification>
{
    ...
    public TodoCreatedEventHandler(ITodoSearchRepository todoSearchRepository)
    {
    ...
    public async Task Handle(TodoCreatedNotification notification, CancellationToken cancellationToken)
    {
        ...
        Console.WriteLine($"Đang xử lý sự kiện Todo đã tạo: {notification.TodoCreatedEvent.Id}");
...
public class TodoCreatedNotification : INotification
{
    ...
    /// Sự kiện Todo đã tạo
    /// </summary>
    public TodoCreatedEvent TodoCreatedEvent { get; }

    /// <summary>
    /// Khởi tạo thông báo với sự kiện
    /// </summary>
    /// <param name="todoCreatedEvent">Sự kiện Todo đã tạo</param>
    public TodoCreatedNotification(TodoCreatedEvent todoCreatedEvent)
    {
        // Lưu trữ sự kiện
